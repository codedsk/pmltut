...
<qgis version="2.10.1-Pisa" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="normValue">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="normValue" symbollevels="0" type="graduatedSymbol" graduatedMethod="GraduatedColor">
    <ranges>
      <range render="true" symbol="0" lower="0.000000" upper="0.100000" label="&lt; 0.1 "/>
      <range render="true" symbol="1" lower="0.100000" upper="0.200000" label="&lt; 0.2 "/>
      <range render="true" symbol="2" lower="0.200000" upper="0.300000" label="&lt; 0.3 "/>
      <range render="true" symbol="3" lower="0.300000" upper="0.400000" label="&lt; 0.4 "/>
      <range render="true" symbol="4" lower="0.400000" upper="0.500000" label="&lt; 0.5 "/>
      <range render="true" symbol="5" lower="0.500000" upper="0.600000" label="&lt; 0.6 "/>
      <range render="true" symbol="6" lower="0.600000" upper="0.700000" label="&lt; 0.7 "/>
      <range render="true" symbol="7" lower="0.700000" upper="0.800000" label="&lt; 0.8 "/>
      <range render="true" symbol="8" lower="0.800000" upper="0.900000" label="&lt; 0.9 "/>
      <range render="true" symbol="9" lower="0.900000" upper="1.000000" label="&lt; 1.0 "/>
      <range render="true" symbol="10" lower="-1.0" upper="-1.0" label="&lt; -1.0 "/>
    </ranges>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="10">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="255,255,255,210"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
    ...
    <labelformat format="&lt; %2 " trimtrailingzeroes="false" decimalplaces="1"/>
    <effect enabled="0" type="effectStack">
      <effect type="dropShadow">
        <prop k="blend_mode" v="13"/>
        <prop k="blur_level" v="10"/>
  ...
  <displayfield>hide</displayfield>
  <label>0</label>
  <labelattributes>
